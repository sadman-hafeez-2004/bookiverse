...
function CategorySection({ allBooks, genres }) {
  // FIX: genres now come from DB so newly added categories appear
...
export default function Home() {
  ...
  // FIX: genres from DB so newly-added categories show up immediately in tabs
  ...
  // FIX: if active tab genre was deleted, reset to All
  useEffect(() => {
  ...
  return (
    <>
      ...
      <div className="hw">
        ...
        {/* FIX: genre tabs now include genres from DB */}
        <div className="ctabs">
          {['All', ...genres].map(g => (
