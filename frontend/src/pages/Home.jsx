...
export default function Home() {
  ...
  return (
    <>
      <style>{`
        /* Page wrapper — same padding as header container */
        .hw {
          width: 100%;
          max-width: 1100px;
          margin: 0 auto;
          ...
          /* KEY: stop any child from causing horizontal scroll */
          overflow-x: hidden;
        }
        ...
        /*
          ...
          This prevents grid items from growing beyond their column.
          Without minmax(0,1fr), an image inside can force the column to expand.
        */
        .bg {
          display: grid;
        ...
        /*
          ...
          The image is absolutely positioned inside so it can never
          change the height of this div — height is always controlled
          by paddingTop alone.
        */
        .bimg {
          width: 100%;
