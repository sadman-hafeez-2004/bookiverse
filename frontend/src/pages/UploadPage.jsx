...
export function UploadPage() {
  ...
  // Check duplicate author name while typing in author form
  const checkDuplicate = (name) => {
    ...
    if (found) {
      setDupWarning(`"${found.name}" already exists. Select them in the Book tab instead.`);
    } else {
      setDupWarning('');
    }
  };
  ...
  const submitAuthor = async (e) => {
    ...
    try {
      ...
      // Auto-select the new author in book form
  ...
  return (
    <>
      <style>{`
        ...
        /* Clickable cover box — same box is input + preview */
        .cover-box {
        ...
        .no-author-found{
          padding:14px 12px; font-size:13px; color:var(--text-3);
          text-align:center;
        }
              ...
              {selectedAuthor ? (
                ...
                <div className="author-chip">
                  ...
                  <button type="button" onClick={clearAuthor} style={{
                    ...
                    fontSize:16, color:'var(--text-3)', padding:0, lineHeight:1,
                  }}>✕</button>
                </div>
              ) : (
